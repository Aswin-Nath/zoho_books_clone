    ...
    return (
        <div className={`bg-gray-600 text-white h-[950px] transition-all duration-200`} style={{ width: isSidebarClosed ? "80px" : "400px" }}>
            ...
            <div className="flex flex-col mt-4  gap-[10px]">
                ...
                {/* Time Tracking */}
                <div>
                    <Link path="#" onClick={() => handleToggle('timeTracking')}  className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700">
                        ...
                        {openSection === 'timeTracking' ? (
                            <img src="https://www.svgrepo.com/show/80156/down-arrow.svg" alt="down arrow" className="h-6 w-6 relative left-[70px]" />
                        ) : (
                            <img src="https://www.svgrepo.com/show/27797/right-arrow.svg" alt="right arrow" className="h-6 w-6 relative left-[70px]" />
                        )}
                    </Link>
                    {openSection === 'timeTracking' && (
                        <ul className="pl-12">
                ...
                {/* Accountant */}
                <div>
                    <Link onClick={() => handleToggle('accountant')} to="#" className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700">
                        <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 455.2 512.6" className="w-6 h-6 text-white"><g id="Layer_1-2"><path d="M215.1 227.8c62.8 0 113.9-51.1 113.9-113.9S277.9 0 215.1 0 101.2 51.1 101.2 113.9s51.1 113.9 113.9 113.9zm0-187.8c40.8 0 73.9 33.2 73.9 73.9s-33.2 73.9-73.9 73.9-73.9-33.2-73.9-73.9S174.4 40 215.1 40zM55.2 378c10.2-36.7 44-62.4 82.2-62.4h127.7c11 0 20-9 20-20s-9-20-20-20H137.4c-27.6 0-53.8 8.8-75.8 25.5s-37.5 39.6-44.9 66.1L2.8 417.1c-6.3 22.7-1.8 46.5 12.5 65.3 14.3 18.8 36 29.6 59.6 29.6h140.3c11 0 20-9 20-20s-9-20-20-20H74.8c-11 0-21.1-5-27.7-13.7-6.6-8.7-8.7-19.8-5.8-30.4L55.2 378zM435.7 386.9l-22.7-4.3c-7-1.3-13.1-5.7-16.5-12l-11.1-20.2c-9-16.5-32.8-16.5-41.8 0l-11.1 20.2c-3.4 6.3-9.5 10.7-16.5 12l-22.7 4.3c-18.5 3.5-25.9 26.1-12.9 39.8l15.8 16.8c4.9 5.2 7.2 12.3 6.3 19.4l-3 22.9c-2.4 18.7 16.8 32.7 33.8 24.6l20.8-9.9c6.5-3.1 14-3.1 20.4 0l20.8 9.9c17 8.1 36.3-5.9 33.8-24.6l-3-22.9c-.9-7.1 1.4-14.2 6.3-19.4l15.8-16.8c12.9-13.7 5.6-36.3-12.9-39.8z"></path></g></svg>
                        <span>Accountant</span>
                        {openSection === 'accountant' ? (
                            <img src="https://www.svgrepo.com/show/80156/down-arrow.svg" alt="down arrow" className="h-6 w-6 relative left-[88px]" />
                        ) : (
                            <img src="https://www.svgrepo.com/show/27797/right-arrow.svg" alt="right arrow" className="h-6 w-6 relative left-[88px]" />
                        )}
                    </Link>
                    {openSection === 'accountant' && (
                        <ul className="pl-12">
                ...
                {/* Reports */}
                <Link to="#" className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700">
                    <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 459.1 512" className="w-6 h-6 text-white"><g id="Layer_1-2"><path d="M382.4 412.6c11 0 20-9 20-20V20c0-11-9-20-20-20s-20 9-20 20v372.6c0 11 9 20 20 20zM77.7 412.6c11 0 20-9 20-20V256c0-11-9-20-20-20s-20 9-20 20v136.6c0 11 9 20 20 20zM229.1 412.6c11 0 20-9 20-20V133.9c0-11-9-20-20-20s-20 9-20 20v258.6c0 11 9 20 20 20zM439.1 472H20c-11 0-20 9-20 20s9 20 20 20h419.1c11 0 20-9 20-20s-9-20-20-20z"></path></g></svg>
                    <span>Reports</span>
                </Link>
                <br></br>
                {/* Documents */}
                <Link to="#" className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700">
                    <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 490" className="w-6 h-6 text-white"><path d="M492.4 192.6c-5.4-6.5-11.7-11.7-18.5-15.6v-29.9c0-43.4-35.3-78.7-78.7-78.7H270.3c-3.5 0-6.9-1.5-9.3-4.2l-40.8-45.6C209.7 6.8 194.4 0 178.5 0h-62C73.1 0 37.8 35.3 37.8 78.7v98.5c-6.7 3.8-12.8 9-18.2 15.4-16.1 19.1-22.8 46.5-18.1 73.2l26.1 147.8c3.7 20.9 13.1 39.9 26.5 53.6C68.5 481.9 86.9 490 106 490h299.9c19 0 37.4-8.1 51.8-22.8 13.6-13.9 22.8-32.4 26.6-53.5l26.3-147.8c4.7-26.7-2-54.1-18.1-73.3zM116.5 40h62c4.6 0 8.9 2 12 5.3l40.8 45.6c10 11.1 24.2 17.5 39.1 17.5h124.9c21.3 0 38.7 17.3 38.7 38.7v22.2H77.8V78.6c0-21.3 17.3-38.7 38.7-38.7zm354.6 218.9l-26.3 147.8c-4.5 25.1-20.9 43.3-39 43.3H106c-18.2 0-34.6-18.2-39-43.3L40.9 258.9c-2.6-14.9 1-30.5 9.4-40.5 3.4-4.1 9.1-8.9 16.7-8.9h378.1c7.6 0 13.3 4.9 16.7 8.9 8.4 10.1 12 25.6 9.4 40.6z" id="Layer_1-2"></path></svg>
                    <span>Documents</span>
                    </Link>
                <br></br>
                {/* More Features */}
                <Link to="#" className="flex items-center space-x-2 px-4 py-2 hover:bg-gray-700">
                    <svg id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 493.58" className="w-6 h-6 text-white"><path d="M372.18 493.58c-10.82 0-21.69-2.61-31.74-7.89l-71.38-37.53c-8.18-4.3-17.95-4.3-26.12 0l-71.38 37.53c-23.1 12.15-50.57 10.16-71.69-5.18-21.12-15.34-31.49-40.85-27.08-66.58l13.63-79.48c1.56-9.11-1.46-18.4-8.07-24.85L20.6 253.31C1.92 235.1-4.68 208.36 3.38 183.54s29.12-42.57 54.95-46.33l79.8-11.6a28.081 28.081 0 0021.14-15.36l35.69-72.31C206.51 14.54 229.9 0 256 0s49.49 14.54 61.04 37.94l35.69 72.31a28.064 28.064 0 0021.14 15.36l79.8 11.6c25.83 3.75 46.88 21.5 54.95 46.33s1.47 51.56-17.22 69.78l-57.74 56.29a28.04 28.04 0 00-8.07 24.85l13.63 79.48c4.41 25.72-5.96 51.24-27.08 66.58-11.93 8.67-25.89 13.07-39.95 13.07zM256 404.94c10.88 0 21.76 2.61 31.68 7.82l71.38 37.53c9.67 5.08 20.72 4.29 29.56-2.14 8.84-6.42 13.01-16.69 11.17-27.45l-13.63-79.48a68.038 68.038 0 0119.58-60.25l57.74-56.29c7.82-7.63 10.48-18.38 7.1-28.77-3.38-10.39-11.85-17.53-22.66-19.1l-79.8-11.6a68.02 68.02 0 01-51.25-37.24l-35.69-72.31c-4.84-9.8-14.25-15.65-25.17-15.65s-20.34 5.85-25.17 15.65l-35.69 72.31a68.1 68.1 0 01-51.25 37.24l-79.8 11.6c-10.81 1.57-19.28 8.71-22.66 19.1-3.38 10.39-.72 21.15 7.1 28.77l57.75 56.29a68.074 68.074 0 0119.58 60.25l-13.63 79.48c-1.85 10.77 2.33 21.03 11.17 27.45 8.84 6.42 19.89 7.22 29.56 2.14l71.38-37.53c9.92-5.21 20.8-7.82 31.68-7.82z" id="Layer_1-2"></path></svg>
