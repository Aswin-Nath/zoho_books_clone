      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        ...
        <Formik
          initialValues={{
            ...
            salesperson: '',
            subject: '',
            items: [{ itemName: '', account: '', quantity: 1, rate: 0, amount: 0 }],
            discount: 0,
            tax: '',
            adjustment: 0,
            customerNotes: '',
            ...
            <Form>
              ...
              <Box sx={{ mb: 4 }}>
                ...
                <Button
                  ...
                  onClick={() => {
                    setFieldValue('items', [...values.items, { itemName: '', account: '', quantity: 1, rate: 0, amount: 0 }]);
                  }}
                >
                  Add New Item
                </Button>
              ...
              {/* Lower Section */}
              <Box>
                <Grid container spacing={3} direction="row" sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 2, mb: 4 }}>
                  <Grid item xs={12} sm={3}>
                  ...
                  <Grid item xs={12} sm={3}>
                    ...
                    <Typography variant="body2" sx={{ mt: 1 }}>
                      Discount Amount: -{((values.items.reduce((sum, item) => sum + item.amount, 0) * values.discount) / 100).toFixed(2)}
                    </Typography>
                  </Grid>
                  <Grid item xs={12} sm={3}>
                    <RadioGroup
                  ...
                  <Grid item xs={12} sm={3}>
                    ...
                    />
                    <Typography variant="body2" sx={{ mt: 1 }}>
                      Adjustment Amount: {parseFloat(values.adjustment || 0).toFixed(2)}
                    </Typography>
                  </Grid>
                  <Grid item xs={12}>
