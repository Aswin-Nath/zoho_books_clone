            ...
            <Form>
              ...
              <Box>
                <Grid container spacing={3} sx={{ p: 3, border: '1px solid #e0e0e0', borderRadius: 2, mb: 4 }}>
                  ...
                  <Grid item xs={12} sm={3}>
                    <Typography variant="body1" sx={{ mt: 2 }}>Sub Total: {values.items.reduce((sum, item) => sum + item.amount, 0)}</Typography>
                  </Grid>
                  <Grid item xs={12} sm={3}>
                    <RadioGroup
                      row
                  ...
                  <Grid item xs={12}>
                    <Typography variant="h6" sx={{ textAlign: 'right', fontWeight: 'bold', mt: 2 }}>
                      Total (₹): {values.items.reduce((sum, item) => sum + item.amount, 0) * (1 - values.discount / 100) + parseFloat(values.adjustment || 0)}
                    </Typography>
                  </Grid>
                </Grid>
                <Grid container spacing={3}>
